...
| :--- | :--- | :--- | :--- |
| `vision_model.onnx` | **FP32** | 43.4 MB | FastViT vision backbone (**recommended for CPU**) |
...
| **Optimal System** | **285.7 MB** | **72.7 MB** | **-74.6%** | **Hybrid: 122 ms total** | >= {min_cosine:.4f} (FP32) | **Hybrid (FP32 Vision + INT8 Text: 105 MB)** |
